...
function addLatestMessageButtons(botElement) {
    ...
    checkButton.classList.add('chuanhu-btn');
    checkButton.classList.add('check-btn');
    checkButton.setAttribute('aria-label', 'Delete');
    checkButton.innerHTML = deleteIcon + `<span>${i18n(check_i18n)}</span>`;
    var gradioCheckBtn = gradioApp().querySelector('#gr-check-btn');
    ...
    messageBtnRowLeading.appendChild(checkButton);
    messageBtnRowLeading.appendChild(movementButton);
